...
from v2xvit.data_utils.datasets.early_fusion_dataset_dair import EarlyFusionDatasetDAIR
from v2xvit.data_utils.datasets.intermediate_fusion_dataset import IntermediateFusionDataset

from v2xvit.data_utils.datasets.intermediate_fusion_dataset_with_early_fusion import IntermediateFusionDatasetWithEarlyFusion
...
from v2xvit.data_utils.datasets.intermediate_fusion_dataset_dair import  IntermediateFusionDatasetDAIR
from v2xvit.data_utils.datasets.late_fusion_dataset_dair import  LateFusionDatasetDAIR
__all__ = {
...
COM_RANGE = 70
# # the final range for evaluation
# GT_RANGE = [-102.4, -38.4, -3, -102.4, 38.4, 1]
# # The communication range for cavs
# COM_RANGE = 100
...
def build_dataset(dataset_cfg, visualize=False, train=True):
    ...
    assert dataset_name in ['LateFusionDataset', 'EarlyFusionDataset',
                            ...
                            'IntermediateFusionDatasetDAIR','EarlyFusionDatasetDAIR',
                            'LateFusionDatasetDAIR',
