...
from v2xvit.data_utils.datasets import early_fusion_dataset
...
class EarlyFusionDataset(basedataset.BaseDataset):
    ...
    def get_item_single_car(self, selected_cav_base, ego_pose):
        ...
        # project the lidar to ego space 将雷达数据传递至中间空间
        lidar_np[:, :3] = \
...
class EarlyFusionDatasetDAIR(EarlyFusionDataset):
    def __init__(self, params, visualize, train=True):
        self.params = params
