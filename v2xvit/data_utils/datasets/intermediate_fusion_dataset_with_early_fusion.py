...
class IntermediateFusionDatasetWithEarlyFusion(basedataset.BaseDataset):
    ...
    def __getitem__(self, idx):
        ...
        for cav_id, selected_cav_base in base_data_dict.items():
            ...
            holistic_bev.append(self.project_points_to_bev(selected_cav_processed['projected_lidar']))
        ...
        merged_holistic_bev = self.convert_to_dict(holistic_bev)
        ...
        processed_data_dict['ego'].update(
            {'object_bbx_center': object_bbx_center,
             ...
             'infra': infra,
             'holistic_bev': merged_holistic_bev,
    ...
    @staticmethod
    def convert_to_dict(holistic_bev_list):
        holistic_bev_dict = {}
        for i, array in enumerate(holistic_bev_list):
            holistic_bev_dict[i] = array
    ...
    def collate_batch_train(self, batch):
        ...
        for i in range(len(batch)):
            ...
            holistic_bev_list.append(ego_dict['holistic_bev'])
        ...
        holistic_bev_dict = self.post_processor.collate_batch_bev(holistic_bev_list)
        ...
        output_dict['ego'].update({'object_bbx_center': object_bbx_center,
                                   ...
                                   'pairwise_t_matrix': pairwise_t_matrix,
                                   'holistic_bev': holistic_bev_dict[0]})
