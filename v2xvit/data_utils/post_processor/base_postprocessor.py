...
class BasePostprocessor(object):
    """
    Template for Anchor generator.锚生成器的模板
    ...
    def generate_gt_bbx(self, data_dict):
        ...
        #change
        if len(gt_box3d_selected_indices)>len(gt_box3d_list):
            gt_box3d_selected_indices = gt_box3d_selected_indices[:len(gt_box3d_list)]
    ...
    def generate_object_center(self,
        ...
        """
        Retrieve all objects in a format of (n, 7), where 7 represents 检索所有对象
    ...
    #for single vehicle
    def generate_gt_bbx_by_iou_single(self, data_dict):
        """
        ...
        for cav_id, cav_content in data_dict.items():
            ...
            #     box_utils.project_box3d(object_bbx_corner.float(),
            #                             transformation_matrix)
            gt_box3d_list.append(object_bbx_corner)
