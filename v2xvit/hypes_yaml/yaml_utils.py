...
def load_point_pillar_params(param):
    ...
    if param['name'] == 'pillarNet_FKD' or \
            param['name'] == 'pillarNet_distillation' or param['name'] =='distillation_opv2v' \
            or param['name'] =='distillation_v2vnet'or param['name'] =='distillation_v2xvit'\
            or param['name'] =='pillarNet_Vim' :
        param['model']['args']['pillarNet_student']['grid_size'] = grid_size
    else:
