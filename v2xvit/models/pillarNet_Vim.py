...
from v2xvit.models.sub_modules.pcnvgg import PillarEncoderDistillation
from v2xvit.models.sub_modules.neck_ViT import Neck_ViT as Pillar_Net_Neck

class PillarNetVim(nn.Module):
    def __init__(self, args):
        super(PillarNetVim, self).__init__()
