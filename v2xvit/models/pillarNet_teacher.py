...
from v2xvit.models.sub_modules.pcnvgg import SpMiddlePillarEncoderVgg,PillarEncoderDistillationTeacher
...
class PillarNetTeacher(nn.Module):
    def __init__(self, args):
        ...
        self.Encoder = PillarEncoderDistillationTeacher(args['pillarNet_teacher'])
