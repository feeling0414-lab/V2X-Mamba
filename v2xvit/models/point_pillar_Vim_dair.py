...
from v2xvit.models.sub_modules.Vim_attention import VIMFusion
from v2xvit.models.sub_modules.Vim_backbone import Vimbackbone
from v2xvit.models.sub_modules.self_attn import AttFusion
from v2xvit.models.sub_modules.ATFuse_change import FusionNet


class PointPillarVimDair(nn.Module):
    def __init__(self, args):
        super(PointPillarVimDair, self).__init__()
        ...
        self.backbone = Vimbackbone(args['grid_size'])
        ...
        self.fusion_net = FusionNet(256)
        #self.fusion_net = VIMFusion(256,args['grid_size'])
