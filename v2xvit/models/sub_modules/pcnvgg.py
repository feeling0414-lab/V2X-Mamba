...
class PillarEncoderDistillation(nn.Module):
    def __init__(
        self, model_cfg, name="PillarEncoderDistillation", **kwargs):
...
class PillarEncoderDistillationTeacher(nn.Module):
    def __init__(
        self, model_cfg, in_planes=32, name="PillarEncoderDistillationTeacher", **kwargs):
        super(PillarEncoderDistillationTeacher, self).__init__()
        self.name = name
        self.nx, self.ny, self.nz = model_cfg['grid_size']
